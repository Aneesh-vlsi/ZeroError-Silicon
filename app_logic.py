...
def handle_hardware_pipeline(board: str, components: str, runtime_key: str):
    ...
    if "COMPILATION REJECTED" in compiled_code or "COMPILATION TERMINATED" in compiled_code or "QUOTA_ERROR" in compiled_code:
        diagnostic_logs = (
        ...
        raw_explanation = "The compilation pipeline encountered a structural system error. Process halted."
